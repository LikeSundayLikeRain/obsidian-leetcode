...
- [x] **INDENT-03**: User can select multiple lines in the fence body and Tab/Shift-Tab to indent/dedent all selected lines as a single undo step
- [x] **INDENT-04**: Indent unit respects the active language (e.g., 4 spaces for Java/Python/C++, 2 for JS/TS)

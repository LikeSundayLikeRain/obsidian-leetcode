...
export function buildReviewPrompt(args: BuildReviewPromptArgs): string {
  return [
    ...
    '',
    '### Approach',
    'Evaluate the algorithm choice. Is this the best approach for this problem? If a fundamentally different algorithm exists with better complexity, include a code fence showing the alternative. Do NOT include code for minor style tweaks — only for a fundamentally different approach.',
    '',
    '### Efficiency',
    'Analyze time and space complexity of the submitted solution. Compare to the optimal known complexity for this problem.',
    '',
    '### Code Style',
    'Evaluate readability, naming conventions, edge-case handling, and idiomatic usage for the language.',
    '',
